...
class Crop extends Component {
    ...
    handleChange = (e) => {
        ...
        if (e.type === "resizemove") {
            const {rect:{width, height}, deltaRect:{left, top, right, bottom}} = e
            ...
            const resize = {
                width: (resizeCoordinate.x + width) <= parentImg.width
                       ? (x + left <= 0 && right === 0) ? coordinate.width : width
                       : coordinate.width,
                height: (resizeCoordinate.y + height) <= parentImg.height
                        ? (y + top <= 0 && bottom === 0) ? coordinate.height : height
                        : coordinate.height,
            }
                nextCoordinate = {
                    ...coordinate,
