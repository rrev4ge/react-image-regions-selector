...
const Crop = (props: ICropProps): React.ReactElement => {
  ...
  }, [prevCoordinate, prevCoordinates]);
  ...
  return (
    ...
    >
      ...
      {hasDeleteButton && <CropDeleteIcon onClick={handleDelete} />}
...
export default memo(Crop, (prevProps, nextProps) => {
  console.log({ prevProps, nextProps });

  const { coordinate, index } = prevProps;
