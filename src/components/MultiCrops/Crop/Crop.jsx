...
import { NumberIcon, CropDeleteIcon, CropContent } from './CropIcons';
...
class Crop extends Component {
      ...
      .resizable({
        ...
        modifiers: [
          ...
          interact.modifiers.restrictSize({
            ...
            max: {
              width: this.props.parentImg?.width,
              height: this.props.parentImg?.height,
            },
          }),
        ],
      })
  ...
  render() {
    const { coordinate, index, numberIcon, cropContent, deleteIcon } =
      this.props;
    return (
      <div
      ...
      >
        ...
        {deleteIcon && <CropDeleteIcon onClick={this.handleDelete} />}
