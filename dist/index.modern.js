...
import { equals, update, is, remove, map, assoc, omit, addIndex, clone, both, complement } from 'ramda';
import { v4 } from 'uuid';
  ...
  function Crop() {
    ...
    _this.changeStartPosition = function (e) {
      ...
      if (['dragstart', 'resizestart'].includes(e.type)) {
        ...
        _this.prevCoordinates = update(index, _this.prevCoordinate, coordinates);
        isChange(e);
      }
    };
